...
CPP=cl.exe
CPP_PROJ=/nologo /MD /W3 /GX /O2 /I "dapi\src\api" /I "C:\Program Files (x86)\DECtalk\include" /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /D "ENGLISH_US" /D "ENGLISH" /Fp"$(INTDIR)\say.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
